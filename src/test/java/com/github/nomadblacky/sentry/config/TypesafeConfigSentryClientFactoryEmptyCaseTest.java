...
class TypesafeConfigSentryClientFactoryEmptyCaseTest {
  ...
  void getBufferedConnectionShutdownTimeout() {
    assertThat(FACTORY.getBufferedConnectionShutdownTimeout(null))
        .isEqualTo(BUFFER_SHUTDOWN_TIMEOUT_DEFAULT);
  }
  ...
  void getMaxMessageLength() {
    assertThat(FACTORY.getMaxMessageLength(null))
        .isEqualTo(JsonMarshaller.DEFAULT_MAX_MESSAGE_LENGTH);
  }
